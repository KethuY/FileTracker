...
public class PickUpAttendanceAdapter extends RecyclerView.Adapter<PickUpAttendanceAdapter.ViewHolder> {
    private List<Student> mStudents;
    private OnItemClickListener mListner;
    private Context mContext;

    public PickUpAttendanceAdapter(List<Student> notifications, OnItemClickListener onItemClickListener) {
        mStudents = notifications;
        mListner = onItemClickListener;
    }

    @Override
    public PickUpAttendanceAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        mContext = parent.getContext();
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.pickup_attendance_item, parent, false);

...
public class StudentPickUpActivity extends BaseActivity implements OnMapReadyCallback,
                   PickUpAttendceFragment.OnStudentPickUpStatusSavedListener,
                   ProcessAsyncRequest.onResponseListener,
                   ...
                   Observer
{
    ...
    private PickUpAttendceFragment mPickUpAtt;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        toolbar.setTitle("Student Pickup");
        setSupportActionBar(toolbar);
        toolbar.setNavigationIcon(ContextCompat.getDrawable(StudentPickUpActivity.this, R.drawable.ic_arrow_back_white_24dp));
        ...
        if (!PermissionChecker.checkPermission(StudentPickUpActivity.this, mLocationPermissions))
        {
            PermissionChecker.reqPermissions(StudentPickUpActivity.this, mLocationPermissions);
        }
        ...
        try
        {
            mCarIcon = Utility.getDrawableIcon(StudentPickUpActivity.this, R.drawable.truck);
        }
        catch (Exception e)
        {
        ...
        try
        {
            ...
            if (null != mLocationManager)
            {
                ...
                try
                {
                    ...
                    {
                        Utility.buildAlertMessageNoGps(StudentPickUpActivity.this);
                    }
                }
                catch (Exception e)
                {
    ...
    private void showStudents()
    {
        ...
        if (mPickUpAtt != null)
        {
            ...
            fm.beginTransaction().remove(mPickUpAtt);
        ...
        mPickUpAtt = new PickUpAttendceFragment();
        FragmentManager fm = getSupportFragmentManager();
        FragmentTransaction ft = fm.beginTransaction();
        ft.replace(R.id.student_frame, mPickUpAtt);
        ft.commit();

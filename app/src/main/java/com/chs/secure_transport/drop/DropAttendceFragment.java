...
import com.chs.secure_transport.pickup.PickUpAttendanceAdapter;
...
public class DropAttendceFragment extends Fragment implements OnItemClickListener ,ProcessAsyncRequest.onResponseListener{
    ...
    private OnStudentDropStatusSavedListener mListner;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        return inflater.inflate(R.layout.fragment_drop_attendce, container, false);
    }
...
route_point_name_*/
    ...
    private void saveStudentPickUp() {
        try {
            RequestObject requestObject = new RequestObject();
            requestObject.setRequestId("CS_REQ_SAVE_STUDENT_TRANSPORT_STATUS");
    ...
    public void onAttach(Context context) {
        ...
        if(context instanceof OnStudentDropStatusSavedListener){
            mListner= (OnStudentDropStatusSavedListener) context;
        }
    }
    ...
    public interface OnStudentDropStatusSavedListener {

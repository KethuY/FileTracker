...
public class DesignationStatusAdapter extends RecyclerView.Adapter<DesignationStatusAdapter.ViewHolder> {

    List<StaDesgination> mTargetGroups;
    OnItemClick mOnItemClick;

    public DesignationStatusAdapter(List<StaDesgination> targetGroups, OnItemClick onItemClick) {

package com.kethu.filetracker.node_type;
...
public class NodeTypeAdapter extends RecyclerView.Adapter<NodeTypeAdapter.ViewHolder> {

    List<StaDesgination> mTargetGroups;
    OnItemClick mOnItemClick;

    public NodeTypeAdapter(List<StaDesgination> targetGroups, OnItemClick onItemClick) {
